...
class ReportsController extends GetxController with GetSingleTickerProviderStateMixin {
  ...
  void onReady() {
    super.onReady();
    // Tidak perlu lagi di sini karena sudah ada di onInit dan akan di-trigger oleh RootController
  }
